...
if (isset($_GET['delete'])) {
    ...
    $delete = mysqli_query($koneksi, "UPDATE gelombang SET deleted = 1 WHERE id='$id'");
}
...
if (isset($_POST['ubah_status'])) {
    ...
    // ubah gelombang kolom status dimana id sama dengan nilai post id
    $ubahStatus = mysqli_query($koneksi, "UPDATE gelombang SET status='$status' WHERE id='$id'");
    header("location:gelombang.php?ubah-status=berhasil");
}
                                        ...
                                        while ($dataGelombang = mysqli_fetch_assoc($queryGelombang)) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a onclick="return confirm('Apakah Anda yakin akan menghapus data ini?')" href="tambah-gelombang.php?delete=<?php echo $dataGelombang['id'] ?>" class="btn btn-danger btn-sm">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
