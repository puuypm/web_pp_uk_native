...
if (isset($_GET['delete'])) {
    ...
    $delete = mysqli_query($koneksi, "UPDATE levels SET deleted = 1 WHERE id='$id'");
}
...
if (isset($_POST['ubah_pilihan'])) {
    ...
    // ubah level kolom pilihan dimana id sama dengan nilai post id
    $ubahPilihan = mysqli_query($koneksi, "UPDATE levels SET pilihan='$pilihan' WHERE id='$id'");
    header("location:level.php?ubah-status=berhasil");
}
?>
?>
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div align="right">
                                <a href="tambah-level.php" class="btn btn-primary mb-4">Tambah Level</a>
                            </div>
