...
if (isset($_POST['daftar'])) {
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO peserta_pelatihan(id_jurusan, id_gelombang, nama_lengkap, nik, kartu_keluarga, jenis_kelamin, tempat_lahir, tanggal_lahir, pendidikan_terakhir, nama_sekolah, kejuruan, nomor_hp, email, aktivitas_saat_ini, status)
        VALUES('$id_jurusan', '$id_gelombang', '$nama_lengkap', '$nik', '$kartu_keluarga', '$jenis_kelamin', '$tempat_lahir', '$tanggal_lahir', '$pendidikan_terakhir', '$nama_sekolah', '$kejuruan', '$nomor_hp', '$email', '$aktivitas_saat_ini', '$status')");
    if ($insert) {
        // redirect
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item"><a href="daftar.php">Pendaftaran</a></li>
                    </ol>
                    <div class="card">
                        <div class="card-header">Pendaftaran Peserta Pelatihan</div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <?php if (isset($_GET['success']) == 'daftar') : ?>
                                        <div class="alert alert-success">Terima kasih sudah mendaftar di PPKD
                                            Jakarta Pusat:)</div>
                                    <?php endif ?>

                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Pendaftaran Peserta Pelatihan PPKD Jakarta
                                            Pusat
                                        </h1>
                                    </div>
                                    <form class="row g-3" method="post">
                                        <div class="col-md-6">
                                            ...
                                            <input name="nama_lengkap" type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">NIK</label>
                                            <input name="nik" type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" required>
                                        </div>
                                        <div class="col-md-5">
                                            <label class="form-label">Kartu Keluarga</label>
                                            <input name="kartu_keluarga" type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Jenis Kelamin</label>
                                            <select name="jenis_kelamin" class="form-select" id="exampleInputPassword" aria-describedby="emailHelp" required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input name="tempat_lahir" type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">Tanggal Lahir</label>
                                            <input name="tanggal_lahir" type="date" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" required>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <input name="pendidikan_terakhir" type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" required>
                                        </div>
                                        <div class="col-md-5">
                                            <label class="form-label">Nama Sekolah</label>
                                            <input name="nama_sekolah" type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" required>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input name="nomor_hp" type="number" class="form-control form-control-user" id="exampleInputPassword" aria-describedby="emailHelp" required>
                                        </div>
                                        <div class="col-md-5">
                                            <label class="form-label">Email</label>
                                            <input name="email" type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" required>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <input name="aktivitas_saat_ini" type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" required>
                                        </div>
                                        <div class="col-12">
                                            <button name="daftar" class="btn btn-primary" type="submit">Daftar</button>
